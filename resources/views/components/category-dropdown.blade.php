<x-dropdown>
    ...
    <x-dropdown-item href="/?{{ http_build_query(request()->except('category', 'page')) }}" :active="request()->routeIs('home')">All</x-dropdown-item> <!-- Check if request is pointing to home page using name routes -->
