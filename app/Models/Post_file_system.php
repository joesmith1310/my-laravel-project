...
class Post {
    ...
    public static function all_alt() {
        ...
        //return cache()->rememberForever('posts.all', function () { //You can access the cache using cache(<key>); You can also cache()->get(<key>) cache()->put cache()->forget() etc.
